...
export declare const select: {
  <P, R>(box: Box<P> | BoxFacadeClass<P>, fn: (value: P) => R): Box<R>;
}


export declare const wrap: {
  <P>(
    getter: (() => P) | Box<P> |  BoxFacadeClass<P>,
  ): Box<P>;
  <P>(
    getter: (() => P) | Box<P> | BoxFacadeClass<P>,
...
export declare const readonly: <P>(box: Box<P> | BoxFacadeClass<P>) => Box<P>;

export declare const on: {
  <P>(
    target: (() => P) | Box<P> | Event<P> | BoxFacadeClass<P>,
...
export declare const sync: {
  <P>(
    target: (() => P) | Box<P> | BoxFacadeClass<P>,
    listener: (value: P, prev: P | void) => void
  ): () => void;
}
...
export declare class BoxFacadeClass<T = void> {
  0: () => T;
  1: (value: T) => void;
